...
import { commentPlugin } from "@/components/editor/kits/comment-kit"
import {
	type TDiscussion,
	discussionPlugin,
} from "@/components/editor/kits/discussion-kit"
import { suggestionPlugin } from "@/components/editor/kits/suggestion-kit"
...
const BlockCommentContent = ({
	...
	if (
		suggestionsCount + resolvedDiscussions.length === 0 &&
		!draftCommentNode
	)
						...
						sortedMergedData.map((item, index) =>
							isResolvedSuggestion(item) ? (
								<BlockSuggestionCard
									...
									idx={index}
									isLast={
										index === sortedMergedData.length - 1
									}
									suggestion={item}
								/>
							) : (
